                  ...
                  <div className="space-y-4">
                    ...
                    {searchType === 'hashtags' && (
                      <div className="space-y-3">
                        {searchResults.map((hashtag: any, index: number) => (
                          <div key={`search-hashtag-${hashtag.tag}-${index}`} className="flex items-center justify-between p-4 border rounded-2xl hover:bg-gray-50 transition-colors cursor-pointer">
